...
namespace jobject
{
    namespace detail
    {
        ...
        {
            static const auto nt_handle = __safecall(GetModuleHandleA).get()(__("ntdll.dll"));
            return reinterpret_cast<T>(__safecall(GetProcAddress).get()(nt_handle, func));
        }
    }
    JOBJECT_FORCEINLINE const auto init()
    {
        /* set apis */
        const static auto NtCreateJobObject = detail::get<detail::typedefs::NtCreateJobObject_t>(__("NtCreateJobObject"));
        const static auto NtAssignProcessToJobObject = detail::get<detail::typedefs::NtAssignProcessToJobObject_t>(__("NtAssignProcessToJobObject"));
        const static auto NtSetInformationJobObject = detail::get<detail::typedefs::NtSetInformationJobObject_t>(__("NtSetInformationJobObject"));
        ...
        NtAssignProcessToJobObject(job, __safecall(GetCurrentProcess).get()());
